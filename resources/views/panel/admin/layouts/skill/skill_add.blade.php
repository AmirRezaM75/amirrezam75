...
<div class="row">
    ...
    <div class="col-lg-12">
        <h2 class="RTL_direction main_fonts">افزودن مهارت</h2>
        {!! Form::open(['method'=>'POST', 'action'=>'SkillsController@store']) !!}
            <div class="form-group has-success has-feedback RTL_direction">
                ...
                <div class="input-group margin-top-20">
                    ...
                    <input name="percentage" id="form_percentage" max="100" min="0" type="number" class="form-control text-right EnFont RTL_direction">
                </div>
