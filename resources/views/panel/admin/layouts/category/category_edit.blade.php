...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{url('/admin/categories')}}">Category Manager</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
...
<div class="row">
    ...
    <div class="col-lg-12">
        <h2 class="RTL_direction main_fonts">ویرایش دسته بندی</h2>
        ...
        <div class="form-group has-success has-feedback RTL_direction">
            <div class="input-group margin-top-20">
                ...
                <input name="name" id="form_name" type="text" class="form-control text-right RTL_direction" value="{{$category->name}}">
            </div>
